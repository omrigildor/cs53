...
m = matutil.listlist2mat([[0,one,one,one,0,one,0,one,0],[one,one,0,one,0,one,one,one,0],[one,one,0,one,0,0,one,0,one],[one,one,one,one,one,one,one,0,one],[one,one,one,one,one,one,0,one,one],[0,one,one,one,0,one,one,one,one],[one,one,0,0,0,0,one,one,0],[0,one,0,one,0,one,one,0,0],[one,one,one,0,one,0,one,0,one]])
