...
def translation(x,y):
    ...
    True
    '''
    return (identity() +  Mat(({'x','y','u'},{'x','y','u'}), {('y','u'):y, ('x','u'):x}))
...
def rotation(angle):
    ...
    True
    '''
    return Mat(({'x','y','u'}, {'x','y','u'}), {('x','x'):math.cos(angle), ('y','y'):math.cos(angle), ('u','u'):1, ('x','y'):-math.sin(angle), ('y','x'):math.sin(angle)})
...
def reflect_x():
    ...
    True
    '''
    return Mat(({'x','y','u'},{'x','y','u'}), {('y','y'): -1, ('x','x'):1, ('u','u'):1})
